...
set rc [catch {
  ...
  add_files /home/andrew/Documents/xilinx_projects/Lab2/Lab2.runs/synth_1/lab2.dcp
...
set rc [catch {
  ...
  catch { report_clock_utilization -file lab2_clock_utilization_placed.rpt }
...
set rc [catch {
  ...
  catch { report_timing_summary -file lab2_timing_summary_routed.rpt -pb lab2_timing_summary_routed.pb }
